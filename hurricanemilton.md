...
Tropical weather is typically reported using nautical terms like *knots* and *nautical* miles rather than miles or kilometers per hour. These terms are defined further below.
...
A *nautical mile* is defined as $\frac{1}{60}$ of a degree (or one minute) of latitude at the equator. This has been standardized to 1,852 meters, or 1.151 statute miles per nautical mile.
